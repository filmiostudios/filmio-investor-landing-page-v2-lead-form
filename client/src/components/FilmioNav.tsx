...
export function FilmioNav() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-foreground/[0.06] bg-background/90 backdrop-blur-xl">
      <div className="relative mx-auto grid h-16 max-w-[1420px] grid-cols-[auto_1fr_auto] items-center px-4 md:px-8">
        <FilmioLogo />
        <div className="pointer-events-none absolute left-1/2 top-1/2 hidden -translate-x-1/2 -translate-y-1/2 sm:block">
          <div className="pointer-events-auto inline-flex items-center gap-2 rounded-full border border-filmio-green/25 bg-filmio-green/10 px-3 py-1.5 shadow-[0_0_28px_rgba(117,246,158,0.08)]">
        ...
        <div className="col-start-3 flex items-center justify-end gap-2 md:gap-3">
          <button
